...
const totalPrice = computed(() => {
  return parseFloat(product.value.sale_price * product.value.units);
});
    ...
    <div class="row">
      ...
      <div class="col">
        <el-form-item prop="sale_price" label="Precio de venta">
          <el-input v-model="product.sale_price" maxlength="5" placeholder="Precio de venta" @input="formatInput" disabled />
        </el-form-item>
      </div>
      <div class="col">
        <el-form-item prop="totalPrice" label="Precio total">
